...
const screens = ["login", "events", "event", "slot", "settings", "requests", "formats", "inbox", "wizard-new", "wizard-basics", "wizard-brief", "wizard-formats", "wizard-assign", "wizard-review"].filter((s) => !only.length || only.includes(s));
