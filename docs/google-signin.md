...
Your app lives at **https://hsdesign.vercel.app**. Your Supabase project is
...
4. Now open https://supabase.com/dashboard/project/gegiwouyrhcexjozkbhh/auth/url-configuration
   - **Site URL**: `https://hsdesign.vercel.app`
...
1. Visit https://hsdesign.vercel.app in a private/incognito window.
...
| Back on the sign-in page with "Sign-in did not complete" | Site URL / redirect list | Step 2.4, make sure `https://hsdesign.vercel.app/**` is listed |
