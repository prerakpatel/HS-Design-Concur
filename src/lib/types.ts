...
export interface Organisation { id: string; slug: string; name: string; short_name: string; accepting_signups: boolean; email_enabled: boolean; chat_enabled: boolean; chat_webhook_url: string | null; logo_path: string | null; }
...
export interface Brief { event_id: string; description: string | null; time_text: string | null; timing_note: string | null; venue_name: string | null; venue_address: string | null; notes: string | null; }
