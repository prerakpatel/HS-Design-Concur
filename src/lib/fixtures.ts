...
export const BRIEF_VIEW = { date: "2026-11-08", timeText: "10:30 AM EST onwards\nFollowed by Aarti and Mahaprasad", inviteText: null as string | null, venueName: "Harisumiran Mandir", venueAddress: "1 Temple Way\nEdison, NJ 08817", notes: "Keep the sponsor line small. Avoid purple." };
...
export const COMMENTS: CommentView[] = [
  { id: "c-1", version: 1, mine: true, body: "Logo is too close to the bottom edge, move it inside the safe area.", created_at: ago(26), pin_x: 0.5, pin_y: 0.93, pin_side: "front", addressed_at: null, confirmed_at: null, author: { name: "Prerak Patel", initials: "PP", avatar: "/preview/avatar.svg", role: "Core Admin" } },
  { id: "c-2", version: 1, body: "@mihir can we try the Gujarati headline in the brand red?", created_at: ago(20), pin_x: null, pin_y: null, pin_side: "front", addressed_at: ago(4), confirmed_at: null, author: { name: "Rina Desai", initials: "RD", role: "Approver" } },
];
