...
export default async function PreviewPage({ params }: { params: Promise<{ screen: string }> }) {
  ...
  if (screen === "wizard-brief") return <WizardShell eventId="e-4" step="brief" title="What goes on the designs?" subtitle="Exactly the words the designers will place: when, the invite text and where. It locks at the first upload; changes then go through comments."><BriefForm eventId="e-4" values={{ event_date: "2026-11-08", time_text: "10:30 AM EST onwards", timing_note: "Followed by Aarti and Mahaprasad", description: F.BRIEF, venue_name: "Harisumiran Mandir", venue_address: "1 Temple Way, Edison, NJ 08817", notes: "" }} action={noopForm} /></WizardShell>;
