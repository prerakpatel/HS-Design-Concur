...
export default async function AwaitingPage() {
  ...
  return (
    <main className="flex min-h-dvh items-center justify-center bg-subtle p-6">
      <div className="w-full max-w-[480px] rounded-3xl border border-border bg-card px-8 py-12 text-center md:px-12">
        ...
        <h1 className="mt-7 text-[32px] font-semibold leading-10 tracking-[-0.02em]">{removed ? "Access removed" : "You are on the list"}</h1>
