  ...
  return (
    <div className="mx-auto max-w-[520px] space-y-10 py-4 md:py-8">
      <div className="text-center">
        ...
        <h1 className="mt-3 text-[24px] font-semibold leading-8 tracking-[-0.02em] md:text-[28px] md:leading-9">Tell us the basics</h1>
        <p className="mx-auto mt-3 max-w-[420px] text-sm leading-6 text-muted-foreground">Anyone in {org.name} can pick this up later if you save and exit.</p>
      </div>
      ...
      <form action={createDraftEvent} className="space-y-6">
        <div className="rounded-xl bg-muted p-1 text-center text-sm font-medium"><span className="block rounded-[10px] bg-card py-2.5 shadow-sm">{org.name}</span></div>
